...
func (m *BookMutation) SetStock(i int) {
	m.stock = &i
	m.addstock = nil
}

// Stock returns the value of the "stock" field in the mutation.
func (m *BookMutation) Stock() (r int, exists bool) {
	v := m.stock
	if v == nil {
		return
	}
...
// OldStock returns the old "stock" field's value of the Book entity.
// If the Book object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *BookMutation) OldStock(ctx context.Context) (v int, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *BookMutation) AddStock(i int) {
	if m.addstock != nil {
		*m.addstock += i
	} else {
		m.addstock = &i
...
func (m *BookMutation) AddedStock() (r int, exists bool) {
	v := m.addstock
	if v == nil {
		return
	}
...
func (m *BookMutation) ResetStock() {
	m.stock = nil
	m.addstock = nil
}
...
func (m *BookMutation) Fields() []string {
	...
	if m.stock != nil {
		fields = append(fields, book.FieldStock)
	}
